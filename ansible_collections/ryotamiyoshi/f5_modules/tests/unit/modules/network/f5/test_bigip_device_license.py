...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_license import (
...
class TestModuleManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher1.start()
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_license.send_teem')
