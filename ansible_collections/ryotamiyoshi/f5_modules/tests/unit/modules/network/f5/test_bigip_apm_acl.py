...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_apm_acl import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_apm_acl.module_provisioned')
        self.m1 = self.p1.start()
        self.m1.return_value = True
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_apm_acl.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_apm_acl.send_teem')
