...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_lx_package import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher1.start()
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_lx_package.tmos_version')
        self.m1 = self.p1.start()
        self.m1.return_value = '12.1.3'
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_lx_package.send_teem')
