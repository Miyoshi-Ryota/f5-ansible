...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_dns import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_dns.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_dns.send_teem')
