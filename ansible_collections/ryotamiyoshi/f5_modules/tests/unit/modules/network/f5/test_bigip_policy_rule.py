...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_policy_rule import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_policy_rule.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_policy_rule.send_teem')
