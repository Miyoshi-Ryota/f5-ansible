...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_snmp_community import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_snmp_community.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_snmp_community.send_teem')
