...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_vcmp_guest import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_vcmp_guest.ModuleParameters.initial_image_exists')
        self.m1 = self.p1.start()
        self.m1.return_value = True
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_vcmp_guest.ModuleParameters.initial_hotfix_exists')
        self.m2 = self.p2.start()
        self.m2.return_value = True
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_vcmp_guest.tmos_version')
        self.p4 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_vcmp_guest.send_teem')
