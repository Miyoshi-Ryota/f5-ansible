...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_firewall_global_rules import (
...
class TestUntypedManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_firewall_global_rules.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_firewall_global_rules.send_teem')
