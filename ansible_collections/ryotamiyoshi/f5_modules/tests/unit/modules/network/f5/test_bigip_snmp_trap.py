...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_snmp_trap import (
...
from ansible_collections.ryotamiyoshi.f5_modules.tests.unit.compat.mock import Mock, patch, DEFAULT
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_snmp_trap.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_snmp_trap.send_teem')
