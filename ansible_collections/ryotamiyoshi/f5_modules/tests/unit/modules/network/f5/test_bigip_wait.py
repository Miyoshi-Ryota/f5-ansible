...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_wait import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher1.start()
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_wait.send_teem')
