...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_tcp_echo import (
...
class TestManagerEcho(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_tcp_echo.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_tcp_echo.send_teem')
