...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ucs_fetch import (
...
class TestV1Manager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ucs_fetch.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ucs_fetch.send_teem')
