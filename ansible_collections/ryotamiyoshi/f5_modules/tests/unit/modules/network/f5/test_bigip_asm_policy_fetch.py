...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_fetch import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher1.start()
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_fetch.module_provisioned')
        self.m1 = self.p1.start()
        self.m1.return_value = True
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_fetch.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_fetch.send_teem')
