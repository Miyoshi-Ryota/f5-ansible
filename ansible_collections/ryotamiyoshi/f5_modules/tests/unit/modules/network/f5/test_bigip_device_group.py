...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_group import (
...
class TestModuleManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_group.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_group.send_teem')
