...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_cgnat_lsn_pool import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_cgnat_lsn_pool.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_cgnat_lsn_pool.send_teem')
