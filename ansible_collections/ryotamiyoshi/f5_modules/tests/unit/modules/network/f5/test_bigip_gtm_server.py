...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_server import (
...
class TestV1Manager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_server.module_provisioned')
        self.m1 = self.p1.start()
        self.m1.return_value = True
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_server.tmos_version')
        self.m2 = self.p2.start()
        self.m2.return_value = '13.0.0'
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_server.send_teem')
