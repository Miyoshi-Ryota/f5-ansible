...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_firewall_address_list import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_firewall_address_list.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_firewall_address_list.send_teem')
