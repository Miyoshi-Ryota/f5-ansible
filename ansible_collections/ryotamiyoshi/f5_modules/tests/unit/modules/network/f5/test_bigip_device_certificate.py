...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_certificate import (
...
from ansible_collections.ryotamiyoshi.f5_modules.tests.unit.compat.mock import Mock
