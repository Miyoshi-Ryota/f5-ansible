...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_message_routing_peer import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_message_routing_peer.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_message_routing_peer.send_teem')
