...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_syslog import (
...
class TestUntypedManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_syslog.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_syslog.send_teem')
