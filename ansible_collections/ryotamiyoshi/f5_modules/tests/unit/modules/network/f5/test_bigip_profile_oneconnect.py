...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_oneconnect import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_oneconnect.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_oneconnect.send_teem')
