...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_pool_member import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_pool_member.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_pool_member.send_teem')
