...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_virtual_server import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_virtual_server.module_provisioned')
        self.m1 = self.p1.start()
        self.m1.return_value = True
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_virtual_server.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_virtual_server.send_teem')
