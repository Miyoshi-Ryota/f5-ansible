...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_regkey_license_assignment import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher1.start()
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_regkey_license_assignment.bigiq_version')
        self.m1 = self.p1.start()
        self.m1.return_value = '6.1.0'
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_regkey_license_assignment.send_teem')
