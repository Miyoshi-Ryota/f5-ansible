...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_http_compression import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_http_compression.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_http_compression.send_teem')
