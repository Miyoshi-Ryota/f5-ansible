...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_file_copy import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_file_copy.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_file_copy.send_teem')
