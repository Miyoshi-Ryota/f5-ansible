...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_snmp_dca import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_snmp_dca.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_snmp_dca.send_teem')
