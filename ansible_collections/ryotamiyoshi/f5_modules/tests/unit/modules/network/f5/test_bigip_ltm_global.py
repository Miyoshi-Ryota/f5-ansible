...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ltm_global import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ltm_global.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ltm_global.send_teem')
