...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_dns_zone import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_dns_zone.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_dns_zone.send_teem')
