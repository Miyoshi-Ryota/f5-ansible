...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_password_policy import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_password_policy.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_password_policy.send_teem')
