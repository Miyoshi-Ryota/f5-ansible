...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_address import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_address.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_address.send_teem')
