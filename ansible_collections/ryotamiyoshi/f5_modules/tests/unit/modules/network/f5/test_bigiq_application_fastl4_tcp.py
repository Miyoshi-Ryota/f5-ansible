...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fastl4_tcp import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher1.start()
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fastl4_tcp.bigiq_version')
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fastl4_tcp.ModuleParameters.template_reference')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fastl4_tcp.ModuleParameters.default_device_reference')
        ...
        self.p5 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fastl4_tcp.send_teem')
