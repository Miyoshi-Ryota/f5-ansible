...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_httpd import (
...
class TestModuleManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher1.start()
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_httpd.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_httpd.send_teem')
