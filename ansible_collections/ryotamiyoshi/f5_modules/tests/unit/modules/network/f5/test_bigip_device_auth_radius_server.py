...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_auth_radius_server import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_auth_radius_server.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_auth_radius_server.send_teem')
