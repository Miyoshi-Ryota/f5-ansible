...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ucs import (
...
class TestV1Manager(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher1.start()
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ucs.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ucs.send_teem')
