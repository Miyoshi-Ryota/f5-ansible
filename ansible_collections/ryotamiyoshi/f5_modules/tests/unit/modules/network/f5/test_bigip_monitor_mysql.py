...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_mysql import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_mysql.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_mysql.send_teem')
