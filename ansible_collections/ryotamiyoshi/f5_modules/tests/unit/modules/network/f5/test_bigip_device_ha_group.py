...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_ha_group import (
...
class TestParameters(unittest.TestCase):
    def test_module_parameters_v13(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_ha_group.tmos_version')
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.m1 = self.p1.start()
        self.m1.return_value = '13.1.0'
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_device_ha_group.send_teem')
