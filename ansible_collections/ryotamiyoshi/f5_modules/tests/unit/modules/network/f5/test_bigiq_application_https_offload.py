...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_https_offload import (
    ModuleParameters, ModuleManager, ArgumentSpec
)
from ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.common import F5ModuleError
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_https_offload.bigiq_version')
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_https_offload.ModuleParameters.template_reference')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_https_offload.ModuleParameters.ssg_reference')
        self.p4 = patch(
            'ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_https_offload.ModuleParameters.default_device_reference'
        )
        ...
        self.p5 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_https_offload.send_teem')
