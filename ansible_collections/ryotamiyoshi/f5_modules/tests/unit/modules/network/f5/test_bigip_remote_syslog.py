...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_remote_syslog import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_remote_syslog.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_remote_syslog.send_teem')
