...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_policy import (
...
class TestSimpleTrafficPolicyManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_policy.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_policy.send_teem')
