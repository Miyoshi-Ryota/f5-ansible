...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server import (
    ApiParameters, ModuleParameters, ModuleManager, ArgumentSpec
)
from ansible_collections.ryotamiyoshi.f5_modules.tests.unit.compat import unittest
from ansible_collections.ryotamiyoshi.f5_modules.tests.unit.compat.mock import Mock, patch
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.modules_provisioned')
        self.m1 = self.p1.start()
        self.m1.return_value = ['ltm', 'gtm', 'asm']
        self.p2 = patch(
            'ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.Parameters._read_current_clientssl_profiles_from_device'
        )
        self.p3 = patch(
            'ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.Parameters._read_current_serverssl_profiles_from_device'
        )
        self.p4 = patch(
            'ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.VirtualServerValidator.check_create'
        )
        self.p5 = patch(
            'ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.VirtualServerValidator.check_update'
        )
        ...
        self.p6 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.tmos_version')
        self.p7 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_virtual_server.send_teem')
