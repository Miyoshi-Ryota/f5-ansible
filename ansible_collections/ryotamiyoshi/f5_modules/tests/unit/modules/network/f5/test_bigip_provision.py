...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_provision import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher1.start()
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_provision.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_provision.send_teem')
