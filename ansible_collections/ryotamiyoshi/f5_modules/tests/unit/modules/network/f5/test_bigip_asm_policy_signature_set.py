...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_signature_set import (
...
class TestParameters(unittest.TestCase):
    def test_module_parameters(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_signature_set.tmos_version')
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_signature_set.module_provisioned')
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_signature_set.tmos_version')
        self.m1 = self.p1.start()
        self.m2 = self.p2.start()
        self.m2.return_value = '13.1.0'
        self.m1.return_value = True
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_asm_policy_signature_set.send_teem')
