...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_certificate import (
...
class TestCertificateManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_certificate.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_certificate.send_teem')
