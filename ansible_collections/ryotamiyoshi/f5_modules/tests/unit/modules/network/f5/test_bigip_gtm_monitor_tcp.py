...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_monitor_tcp import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_monitor_tcp.module_provisioned')
        self.m1 = self.p1.start()
        self.m1.return_value = True
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_monitor_tcp.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_gtm_monitor_tcp.send_teem')
