...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_partition import (
...
class TestManagerEcho(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_partition.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_partition.send_teem')
