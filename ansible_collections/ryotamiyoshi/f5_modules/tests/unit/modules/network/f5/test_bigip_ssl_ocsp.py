...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_ocsp import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_ocsp.tmos_version')
        self.m1 = self.p1.start()
        self.m1.return_value = '13.0.0'
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_ocsp.send_teem')
