...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_key_cert import (
...
class TestModuleManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_key_cert.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_ssl_key_cert.send_teem')
