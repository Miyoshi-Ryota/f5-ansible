...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_log_destination import (
...
class TestModuleManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_log_destination.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_log_destination.send_teem')
