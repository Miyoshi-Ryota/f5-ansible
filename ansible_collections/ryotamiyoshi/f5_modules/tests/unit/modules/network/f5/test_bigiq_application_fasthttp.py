...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fasthttp import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p1 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fasthttp.bigiq_version')
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fasthttp.ModuleParameters.template_reference')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fasthttp.ModuleParameters.ssg_reference')
        self.p4 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fasthttp.ModuleParameters.default_device_reference')
        ...
        self.p5 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigiq_application_fasthttp.send_teem')
