...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_sys_daemon_log_tmm import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_sys_daemon_log_tmm.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_sys_daemon_log_tmm.send_teem')
