...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_irule import (
...
from ansible_collections.ryotamiyoshi.f5_modules.tests.unit.compat.mock import Mock, patch, mock_open
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_irule.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_irule.send_teem')
