...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_qkview import (
...
class TestMadmLocationManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_qkview.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_qkview.send_teem')
