...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_imish_config import (
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_imish_config.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_imish_config.send_teem')
