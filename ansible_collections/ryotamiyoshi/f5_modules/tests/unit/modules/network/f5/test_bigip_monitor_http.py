...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_http import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_http.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_monitor_http.send_teem')
