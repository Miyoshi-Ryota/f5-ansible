...
from ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_client_ssl import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_client_ssl.tmos_version')
        self.p3 = patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.modules.bigip_profile_client_ssl.send_teem')
