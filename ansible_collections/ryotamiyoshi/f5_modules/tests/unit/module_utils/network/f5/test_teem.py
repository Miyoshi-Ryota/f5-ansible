...
from ansible_collections.ryotamiyoshi.f5_modules.tests.unit.compat.mock import patch, Mock, mock_open
from ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.constants import TEEM_KEY
from ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem import (
    TeemClient, determine_environment, generate_asset_id, in_docker, in_cicd
)
from ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.version import CURRENT_COLL_VERSION
...
class TestTeemClient(unittest.TestCase):
    ...
    @patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem.in_cicd', new_callable=Mock())
    ...
    @patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem.socket.gethostname', new_callable=Mock())
    @patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem.in_cicd', new_callable=Mock())
    ...
    @patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem.in_cicd', new_callable=Mock())
    @patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem.open_url')
    ...
    def test_teem_get_platform_fq_name(self):
        self.fake_module._name = 'ryotamiyoshi.f5_modules.bigip_fake'
        teem = TeemClient(self.start_time, self.fake_module, '15.1.1')
    ...
    def test_teem_get_platform_fq_name_platform_not_found(self):
        self.fake_module._name = 'ryotamiyoshi.f5_modules.foobar_fake'
        teem = TeemClient(self.start_time, self.fake_module, '15.1.1')
        result = teem.get_platform()
...
class TestOtherFunctions(unittest.TestCase):
    def test_determine_environment_drone(self):
        ...
        with patch('ansible_collections.ryotamiyoshi.f5_modules.plugins.module_utils.teem.os.getenv') as env:
