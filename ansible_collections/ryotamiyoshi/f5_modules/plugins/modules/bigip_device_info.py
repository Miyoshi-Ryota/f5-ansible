...
options:
  ...
  gather_subset:
    ...
    choices:
      ...
      - "!vlans"
    aliases: ['include']
extends_documentation_fragment: ryotamiyoshi.f5_modules.f5
author:
  - Tim Rupp (@caphrim007)
...
def main():
    ...
    try:
        ...
        # issue originally found and submitted in https://github.com/ryotamiyoshi/f5-ansible/pull/1477 by @traittinen
